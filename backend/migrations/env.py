...
def run_migrations_offline() -> None:
    """Roda migrações em modo offline (gera SQL sem conectar no banco)."""
...
def do_run_migrations(connection: Connection) -> None:
    """Executa as migrações dentro de uma connection síncrona (run_sync)."""
...
async def run_async_migrations() -> None:
    """Cria o engine async a partir do alembic.ini e roda as migrações."""
...
def run_migrations_online() -> None:
    """Roda migrações online (conecta no banco de verdade)."""
